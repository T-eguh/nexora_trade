      ...
      <div className="space-y-10">
        {platforms.map((platform) => (
          <section
            key={platform.id}
            id={platform.id}
            className="scroll-mt-24 bg-[#0D0D0F] border border-neutral-800 rounded-2xl p-6 sm:p-8 space-y-6"
          >
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-neutral-800 pb-4">
              <div className="flex items-center gap-3.5">
                <div className="w-12 h-12 rounded-xl bg-[#151518] border border-neutral-800 flex items-center justify-center text-red-500">
                ...
                <div>
                  ...
                  <p className="text-xs text-neutral-400">{platform.tagline}</p>
                </div>
              </div>
